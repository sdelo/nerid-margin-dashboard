...
/** Get the client for the specified network with MVR overrides. */
export const getClient = (network: Network) => {
    const packageId = CONTRACTS[network as keyof typeof CONTRACTS].MARGIN_PACKAGE_ID;
	return new SuiClient({ 
        url: getFullnodeUrl(network),
        mvr: {
            overrides: {
                packages: {
                    '@local-pkg/deepbook-margin': packageId,
                },
            },
        },
    });
